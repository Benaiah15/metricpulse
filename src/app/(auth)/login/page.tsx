...
// 1. We extract all the logic and UI into an inner component
...
// 2. Our main export simply wraps the inner component in the Suspense boundary Next.js demands
export default function LoginPage() {
  return (
    <main className="min-h-screen bg-neutral-950 flex flex-col justify-center items-center p-4 font-sans text-neutral-50">
      <Suspense fallback={<div className="text-emerald-500 flex flex-col items-center gap-2"><Loader2 className="animate-spin" size={24} /></div>}>
        <LoginFormContent />
      </Suspense>
    </main>
  );
